//make a program that calculates the product using addition of two natrual values

#include <stdio.h>

int main(){

	int a,b,res=0,i=1; //define the a,b input variables, res for the result and i for the loop
